...
// Wed Dec 29 16:52:11 2021 by ROOT version 6.20/04
// from TTree output_tree/
// found on file: lbyl_diphoton_genInfo.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("lbyl_diphoton_genInfo.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("lbyl_diphoton_genInfo.root");
      }
