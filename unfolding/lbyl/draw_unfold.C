...
void draw_unfold(int method =1)
{
  ...
  TLegend *leg1=new TLegend(0.65,0.72,0.90,0.9);
  leg1->SetFillColor(0);
  ...
  leg1->AddEntry(hMuMu_pt_gen,"Gen","pl");
  leg1->AddEntry(hMuMu_pt_recomc,"Reco MC","pl");

  TLegend *leg2=new TLegend(0.65,0.68,0.90,0.9);
  leg2->SetFillColor(0);
  ...
  leg2->AddEntry(hMuMu_pt_gen,"Gen","pl");
  leg2->AddEntry(hMuMu_pt_recomc,"Reco MC","pl");
  ...
  make_hist(hMuMu_pt_unfomc,"diphoton p_{T} (GeV/c)","d#sigma/dp_{T} (nb/GeV/c)",20,1.0,kRed,1,1);
  hMuMu_pt_unfomc->Draw("p");
  make_hist(hMuMu_pt_gen,"diphoton p_{T} (GeV/c)","d#sigma/dp_{T} (nb/GeV/c)",20,1.0,kGreen,1,2);
  hMuMu_pt_gen->Draw("histsame");

  make_hist(hMuMu_pt_recomc,"diphoton p_{T} (GeV/c)","d#sigma/dp_{T} (nb/GeV/c)",20,1.0,kBlue,1,2);
  hMuMu_pt_recomc->Draw("histsame");
  
  //CMS_lumi( c1, 1, 10 );
  leg1->Draw();
  c1->Print(Form("./fig/closure_pt_%s.gif",MethID1));
  ...
  make_hist(hMuMu_pt_unfodata,"diphoton p_{T} (GeV/c)","d#sigma/dp_{T} (nb/GeV/c)",20,1.0,kRed,1,2);
  hMuMu_pt_unfodata->Draw("p");
  hMuMu_pt_gen->Draw("histsame");
  hMuMu_pt_recomc->Draw("ehistsame");
  make_hist(hMuMu_pt_recodata,"diphoton p_{T} (GeV/c)","d#sigma/dp_{T} (nb/GeV/c)",22,1.0,kBlack,1,2);
  hMuMu_pt_recodata->Draw("ehistsame");
  
  //CMS_lumi( c2, 1, 10 );
  leg2->Draw();
  c2->Print(Form("./fig/data_pt_%s.gif",MethID1));
  ...
  make_hist(hMuMu_rapidity_unfomc,"diphoton y","d#sigma/dy (nb)",20,1.0,kRed,1,1);
  hMuMu_rapidity_unfomc->Draw("p");
  make_hist(hMuMu_rapidity_gen,"diphoton y","d#sigma/dy (nb)",20,1.0,kGreen,1,2);
  hMuMu_rapidity_gen->Draw("histsame");

  make_hist(hMuMu_rapidity_recomc,"diphoton y","d#sigma/dy (nb)",20,1.0,kBlue,1,2);
  hMuMu_rapidity_recomc->Draw("histsame");
  
  //CMS_lumi( c3, 1, 10 );
  leg1->Draw();
  c3->Print(Form("./fig/closure_rapidity_%s.gif",MethID1));
  ...
  make_hist(hMuMu_rapidity_unfodata,"diphoton y","d#sigma/dy (nb)",20,1.0,kRed,1,2);
  hMuMu_rapidity_unfodata->Draw("p");
  hMuMu_rapidity_gen->Draw("histsame");
  hMuMu_rapidity_recomc->Draw("ehistsame");
  make_hist(hMuMu_rapidity_recodata,"diphoton y","d#sigma/dy (nb)",22,1.0,kBlack,1,2);
  hMuMu_rapidity_recodata->Draw("ehistsame");
  
  //CMS_lumi( c4, 1, 10 );
  leg2->Draw();
  c4->Print(Form("./fig/data_rapidity_%s.gif",MethID1));
 ...
 TCanvas* c5 = new TCanvas("c5","Dimuon invmass",50,50,W,H);
  ...
  make_hist(hMuMu_invmass_unfomc,"diphoton Invmass","d#sigma/dm (nb/Gev)",20,1.0,kRed,1,1);
  hMuMu_invmass_unfomc->Draw("p");
  make_hist(hMuMu_invmass_gen,"diphoton Invmass","d#sigma/dm (nb/Gev)",20,1.0,kGreen,1,2);
  hMuMu_invmass_gen->Draw("histsame");

  make_hist(hMuMu_invmass_recomc,"diphoton Invmass","d#sigma/dm (nb/Gev)",20,1.0,kBlue,1,2);
  hMuMu_invmass_recomc->Draw("histsame");
  
  //CMS_lumi( c5, 1, 10 );
  leg1->Draw();
  c5->Print(Form("./fig/closure_invmass_%s.gif",MethID1));
  ...
  make_hist(hMuMu_invmass_unfodata,"diphoton Invmass","d#sigma/dm (nb/Gev)",20,1.0,kRed,1,2);
  hMuMu_invmass_unfodata->Draw("p");
  hMuMu_invmass_gen->Draw("histsame");
  hMuMu_invmass_recomc->Draw("ehistsame");
  make_hist(hMuMu_invmass_recodata,"diphoton Invmass","d#sigma/dm (nb/Gev)",22,1.0,kBlack,1,2);
  hMuMu_invmass_recodata->Draw("ehistsame");
  
  //CMS_lumi( c6, 1, 10 );
  leg2->Draw();
  c6->Print(Form("./fig/data_invmass_%s.gif",MethID1));
