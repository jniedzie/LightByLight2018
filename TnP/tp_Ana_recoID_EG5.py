...
EFFICIENCYSET =cms.PSet(
        elereco_1bin = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("ok_elematch","true","ok_ID","true"),
...
process.tagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    #OutputFileName = cms.string("tnp_Ana_%s_EleRecoID_singleEG_absEta_EmilienComments_singleEG5TriggerOnly.root" % ( dataOrMC)),
    OutputFileName = cms.string("tnp_Ana_%s_EleRecoID_singleEG3_DPNote.root" % ( dataOrMC)),
