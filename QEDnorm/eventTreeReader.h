...
// Mon Nov 20 17:17:55 2017 by ROOT version 6.04/02
...
#ifndef eventTreeReader_h
#define eventTreeReader_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<int>     *hypho_genMatchedIndex;
   Int_t           ngsfEle;
   ...
   TBranch        *b_hypho_genMatchedIndex;   //!
   TBranch        *b_ngsfEle;   //!
   ...
   eventTreeReader(TTree *tree=0);
   virtual ~eventTreeReader();
...
#ifdef eventTreeReader_cxx
eventTreeReader::eventTreeReader(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_diffraction/diphoton/qed_ee/hiforest_noptcut_3-53_invmass_more_var3/0002/hiForest_qedee_4.root:/ggHiNtuplizer");
...
Int_t eventTreeReader::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t eventTreeReader::LoadTree(Long64_t entry)
{
...
void eventTreeReader::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("hypho_genMatchedIndex", &hypho_genMatchedIndex, &b_hypho_genMatchedIndex);
...
void eventTreeReader::Show(Long64_t entry)
{
...
Int_t eventTreeReader::Cut(Long64_t entry)
{
...
#endif // #ifdef eventTreeReader_cxx
