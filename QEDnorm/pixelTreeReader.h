...
// Mon Nov 20 17:17:33 2017 by ROOT version 6.04/02
...
#ifndef pixelTreeReader_h
#define pixelTreeReader_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         vy[2];   //[nv]
   Float_t         vz[2];   //[nv]
   Float_t         eta1[60];   //[nhits1]
   Float_t         phi1[60];   //[nhits1]
   Float_t         r1[60];   //[nhits1]
   Float_t         cs1[60];   //[nhits1]
   Float_t         ch1[60];   //[nhits1]
   Float_t         eta2[43];   //[nhits2]
   Float_t         phi2[43];   //[nhits2]
   Float_t         r2[43];   //[nhits2]
   Float_t         cs2[43];   //[nhits2]
   Float_t         ch2[43];   //[nhits2]
   Float_t         eta3[46];   //[nhits3]
   Float_t         phi3[46];   //[nhits3]
   Float_t         r3[46];   //[nhits3]
   Float_t         cs3[46];   //[nhits3]
   Float_t         ch3[46];   //[nhits3]
   Float_t         eta4[13];   //[nhits4]
   Float_t         phi4[13];   //[nhits4]
   Float_t         r4[13];   //[nhits4]
   Float_t         cs4[13];   //[nhits4]
   Float_t         ch4[13];   //[nhits4]
   Float_t         eta5[13];   //[nhits5]
   Float_t         phi5[13];   //[nhits5]
   Float_t         r5[13];   //[nhits5]
   Float_t         cs5[13];   //[nhits5]
   Float_t         ch5[13];   //[nhits5]
   ...
   pixelTreeReader(TTree *tree=0);
   virtual ~pixelTreeReader();
...
#ifdef pixelTreeReader_cxx
pixelTreeReader::pixelTreeReader(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_diffraction/diphoton/qed_ee/hiforest_noptcut_3-53_invmass_more_var3/0002/hiForest_qedee_4.root:/pixel");
...
pixelTreeReader::~pixelTreeReader()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t pixelTreeReader::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t pixelTreeReader::LoadTree(Long64_t entry)
{
...
void pixelTreeReader::Init(TTree *tree)
{
...
void pixelTreeReader::Show(Long64_t entry)
{
...
Int_t pixelTreeReader::Cut(Long64_t entry)
{
...
#endif // #ifdef pixelTreeReader_cxx
