...
double Gammagammasingle::getWidth()
{
  ...
  case starlightConstants::ZOVERZ03:
    ...
    break;
  case starlightConstants::AXION: // AXION HACK
    singlewidth = 1/(64*starlightConstants::pi)*_axionMass*_axionMass*_axionMass/(long(ax_lambda)*long(ax_lambda));//Fix Lambda=1000 GeV,rescaling is trivial.    // AXION HACK
    break;
  default:
