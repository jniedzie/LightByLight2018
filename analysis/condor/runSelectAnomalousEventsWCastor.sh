...
basePathOutput="/eos/cms/store/group/phys_heavyions/osuranyi"
...
then
  ...
  outputPath="${basePathOutput}/lbyl_2018/anomalous_plots/data${suffix}"
elif [ $2 -eq 1 ]
then
  ...
  outputPath="${basePathOutput}/lbyl_2018/anomalous_plots/mc_qed_sc${suffix}"
elif [ $2 -eq 2 ]
then
  ...
  outputPath="${basePathOutput}/lbyl_2018/anomalous_plots/mc_qed_sl${suffix}"
elif [ $2 -eq 3 ]
then
  ...
  outputPath="${basePathOutput}/lbyl_2018/anomalous_plots/mc_lbl_sc${suffix}"
elif [ $2 -eq 4 ]
then
  ...
  outputPath="${basePathOutput}/lbyl_2018/anomalous_plots/mc_cep_sc${suffix}"
fi
...
then
  ...
  /afs/cern.ch/work/o/osuranyi/public/LightByLight2018/analysis/selectAnomalousEventsWCastorVeto $configPath $inputPath $output $sampleName
fi
