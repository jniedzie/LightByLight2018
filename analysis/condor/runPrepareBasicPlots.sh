...
then
  ...
  outputPath="/eos/cms/store/group/phys_diffraction/lbyl_2018/basicPlots_data"
else
 # MC
  ...
  outputPath="/eos/cms/store/group/phys_diffraction/lbyl_2018/basicPlots_mc"
fi
...
/afs/cern.ch/work/j/jniedzie/private/LightByLight2018/analysis/prepareBasicPlots $configPath $inputPath $output
