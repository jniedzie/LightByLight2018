...
then
# default
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_default.md"
  suffix="_default_tracker_branches"
elif [ $3 -eq 1 ]
then
# HF thresholds increased to 20 GeV
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_HF_20GeV.md"
  suffix="_HF_20GeV"
elif [ $3 -eq 2 ]
then
  # add n hits ≥ 11 requirement on tracks
    configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_tracks+nhits.md"
    suffix="_tracks+nhits"
elif [ $3 -eq 3 ]
then
  # add chi2 < 2.5 requirement on tracks
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_tracks+chi2.md"
  suffix="_tracks+chi2"
elif [ $3 -eq 4 ]
then
  # add pt > 500 MeV requirement on tracks
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_tracks+pt.md"
  suffix="_tracks+pt"
elif [ $3 -eq 5 ]
then
  # add n hits ≥ 7 requirement on tracks
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_tracks+nhits7.md"
  suffix="_tracks+nhits7"
elif [ $3 -eq 6 ]
then
  # add n hits ≥ 3 requirement on tracks
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_tracks+nhits3.md"
  suffix="_tracks+nhits3"
elif [ $3 -eq 7 ]
then
  # add n hits ≥ 5 requirement on tracks
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_tracks+nhits5.md"
  suffix="_tracks+nhits5"
elif [ $3 -eq 8 ]
then
  # add pt > 700 MeV requirement on tracks
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_tracks+pt700.md"
  suffix="_tracks+pt700"
elif [ $3 -eq 9 ]
then
  # add pt > 900 MeV requirement on tracks
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_tracks+pt900.md"
  suffix="_tracks+pt900"
elif [ $3 -eq 10 ]
then
  # add pt > 200 MeV requirement on tracks
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_tracks+pt200.md"
  suffix="_tracks+pt200"
elif [ $3 -eq 11 ]
then
  # add pt > 300 MeV requirement on tracks
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_tracks+pt300.md"
  suffix="_tracks+pt300"
elif [ $3 -eq 12 ]
then
  # add pt > 400 MeV requirement on tracks
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_tracks+pt400.md"
  suffix="_tracks+pt400"
elif [ $3 -eq 13 ]
then
  # add no conversion requirement on photons
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_pho+conversions.md"
  suffix="_pho+conversions"
elif [ $3 -eq 14 ]
then
  # add d_xy < 1 mm requirement on tracks
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_tracks+dxy1mm.md"
  suffix="_tracks+dxy1mm"
elif [ $3 -eq 15 ]
then
  # add pt < 0.8 requirement on diphoton
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_diphoton+pt_0p8.md"
  suffix="_diphoton+pt_0p8"
elif [ $3 -eq 16 ]
then
  # add dxy_bs < 1 mm requirement on tracks
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_tracks+dxybs1mm.md"
  suffix="_tracks+dxybs1mm"
elif [ $3 -eq 17 ]
then
  # remove all track requirements
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_tracks+no_cuts.md"
  suffix="_tracks+no_cuts"
elif [ $3 -eq 18 ]
then
  # remove all track requirements
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_EEnoiseEtaDep.md"
  suffix="_EEnoiseEtaDep"
elif [ $3 -eq 19 ]
then
  # remove all track requirements
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_EEnoiseEta_2p4.md"
  suffix="_EEnoiseEta_2p4"
elif [ $3 -eq 20 ]
then
  # remove all track requirements
  configPath="$basepath/LightByLight2018/analysis/configs/preparePlots_EBnoise_1p0.md"
  suffix="_EBnoise_1p0"
elif [ $3 -eq 21 ]
then
  # max 50 pixel hits
...
#  inputPath=`sed "${1}q;d" $basepath/LightByLight2018/analysis/input_list.txt`
...
echo $basepath/LightByLight2018/analysis/prepareBasicPlots $configPath $inputPath $output $sampleName
$basepath/LightByLight2018/analysis/prepareBasicPlots $configPath $inputPath $output $sampleName
