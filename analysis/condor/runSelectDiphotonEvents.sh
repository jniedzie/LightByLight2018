...
then
  ...
  outputPath="${basePath}/analysis_ruchi/diphoton_data-MC_plots/mc_qed_sc${suffix}"
elif [ $2 -eq 2 ]
then
...
then
  ...
  outputPath="${basePath}/analysis_ruchi/diphoton_data-MC_plots/mc_lbl_sc${suffix}"
elif [ $2 -eq 4 ]
then
  ...
  outputPath="${basePath}/analysis_ruchi/diphoton_data-MC_plots/mc_cep_sc${suffix}"
fi


mkdir -p $outputPath
output="${outputPath}/data-MC_plots_diphoton_${1}.root"
