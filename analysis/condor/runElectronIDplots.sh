...
output="/eos/cms/store/group/phys_diffraction/lbyl_2018/analysis/electronIDplots/electronID_${1}.root"

/afs/cern.ch/work/j/jniedzie/private/LightByLight2018/analysis/prepareElectronIDplots $configPath $inputPathData $inputPathLbL $inputPathQED_SC $inputPathQED_SL $inputPathCEP $output
