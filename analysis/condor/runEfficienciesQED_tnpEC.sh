...
suffix="_eleRecoIDTrigger_tnpEC_22Nov21_OliversThreshold_efficiencies_eleNoIsolation_newThresholds"
...
then
  ...
  /afs/cern.ch/work/r/rchudasa/private/LightByLight2018/analysis/getEfficienciesQED_tnpEC $configPath $inputPath $output $sampleName
fi
