...
configPath="/afs/cern.ch/work/o/osuranyi/public/LightByLight2018/analysis/configs/efficiencies.md"
...
then
  ...
  outputPath="${basePath}/lbyl_2018/castorPlots/castorPlots_data${suffix}"
#elif [ $2 -eq 1 ]
#then
...
mkdir -p $outputPath
output="${outputPath}/castorPlots_${1}.root"
...
then
  ...
  /afs/cern.ch/work/o/osuranyi/public/LightByLight2018/analysis/prepareCastorPlots $configPath $sampleName $inputPath $output
fi
