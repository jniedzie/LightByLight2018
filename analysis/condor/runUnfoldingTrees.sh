...
baseOutPath="/eos/cms/store/group/phys_diffraction/lbyl_2018"
suffix="_forUnfolding_withGenInfov3"
...
then
  ...
  outputPath="${baseOutPath}/analysis_ruchi/qed_data-MC_plots/data${suffix}"
elif [ $2 -eq 1 ]
then
...
#  inputPath="${basePath}/mc_qed/ntuples_superchic_1034/ntuples_sc_1034/ntuples_sc_1034/191113_105005/0000/HiForestAOD_LbyL_full_sample_lbyl_reco_${1}.root"
  ...
  outputPath="${baseOutPath}/analysis_ruchi/qed_data-MC_plots/mc_qed_sc${suffix}"
elif [ $2 -eq 2 ]
then
  ...
  outputPath="${baseOutPath}/analysis_ruchi/qed_data-MC_plots/mc_qed_sl${suffix}"
fi


mkdir -p $outputPath
output="${outputPath}/QEDMC_forUnfolding_${1}.root"
...
then
  ...
  /afs/cern.ch/work/r/rchudasa/private/LightByLight2018/analysis/makeQEDUnfoldingTrees $configPath $inputPath $output $sampleName
fi
