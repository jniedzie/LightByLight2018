...
inputPathData="/eos/cms/store/group/phys_diffraction/lbyl_2018/data_withSingleEG3/ntuples/data_HiForestAOD_withSingleEG3_${1}.root"
...
output="/eos/cms/store/group/phys_diffraction/lbyl_2018/analysis/efficienciesQED/data_HiForestAOD/efficienciesQED_${1}.root"
