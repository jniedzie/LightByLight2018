...
// Wed Mar  2 16:25:57 2022 by ROOT version 6.20/04
// from TTree output_tree/
// found on file: QEDSC_cosThetaStar_qed.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("QEDSC_cosThetaStar_qed.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("QEDSC_cosThetaStar_qed.root");
      }
