...
output="/eos/cms/store/group/phys_diffraction/lbyl_2018/mc_qed/efficiency_sc/efficienciesData_${1}.root"

/afs/cern.ch/work/j/jniedzie/private/LightByLight2018/analysis/getEfficienciesData $configPath $inputPath $output
