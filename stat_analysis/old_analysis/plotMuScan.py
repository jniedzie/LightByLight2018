...
f_obs = TFile("higgsCombineObs.MultiDimFit.mH120.root","READ")
...
dummy = TH1D("dummy","dummy", 1, 0.0,3.0)
...
f1 = TF1("f1","1.0",0.0,3.0)
f1.SetLineColor(2)
f1.SetLineWidth(2)
f1.Draw("lsame")
latexf.DrawLatex(2.5, 1.1,"68% CL")
f2 = TF1("f1","3.84",0.0,3.0)
f2.SetLineColor(2)
f2.SetLineWidth(2)
f2.Draw("lsame")
...
latex2.DrawLatex(0.87, 0.95,"PbPb 391 #mu b^{-1} (5.02 TeV)")
