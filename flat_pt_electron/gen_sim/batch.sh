...
# Set those variables:
config_path=/afs/cern.ch/work/r/rchudasa/private/ruchi_reco_2018/CMSSW_10_3_2/src/Configuration/Generator/python/flat_pt_electron/gen_sim/SingleGammaFlatPt_pythia8_cfi_GEN_SIM.py
...
output_path=/eos/cms/store/group/phys_diffraction/lbyl_2018/mc_flat_pt_electron/gen_sim/
outfilename="flatpt_electron_gen_sim_${1}.root"
