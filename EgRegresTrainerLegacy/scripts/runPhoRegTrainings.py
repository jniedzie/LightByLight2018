...
def main():
    ...
    input_ideal_ic  = "/eos/cms/store/group/phys_diffraction/lbyl_2018/mc_flat_pt_photon/reco_lbl_modifier/flat_photon_refined_sc_ntuples/flat_photon_refined_sc/190718_105708/0001/flatpt_photon_refined_sc_ntuples.root"
    ...
    regArgs.cuts_base = base_pho_cuts.format(extra_cuts = "evt.eventnr%4==0")
