...
// $Date:: 2017-11-11 14:46:05 +0000 #$: date of last commit
//
// Description:
//
//
...
#endif
{
  ...
  _axionMass=ax_mass;//inputParametersInstance.axionMass(); // AXION HACK
...
double Gammagammasingle::getWidth()
{
  ...
  case starlightConstants::ZOVERZ03:
    ...
    break;
  case starlightConstants::AXION: // AXION HACK
    singlewidth = 1/(64*starlightConstants::pi)*_axionMass*_axionMass*_axionMass/ax_lambda/ax_lambda;//Fix Lambda=1000 GeV,rescaling is trivial.    // AXION HACK
    break;
  default:
