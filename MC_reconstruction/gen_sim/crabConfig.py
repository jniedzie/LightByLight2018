...
config.General.requestName = 'gen_sim_qed_superchic_with_cuts'
...
config.Data.outputPrimaryDataset = 'gen_sim_qed_superchic_with_cuts'
...
config.Data.outLFNDirBase = '/store/group/phys_diffraction/lbyl_2018/mc_qed/gen_sim_qed_superchic_with_cuts'
