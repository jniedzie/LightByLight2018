...
config.General.requestName = 'digi_raw_cep'
...
config.Data.outputPrimaryDataset = 'digi_raw_cep'
...
config.Data.outLFNDirBase = '/store/group/phys_diffraction/lbyl_2018/mc_cep/digi_raw'
config.Data.allowNonValidInputDataset = True
config.Data.publication = True
config.Data.outputDatasetTag = 'digi_raw_cep'
